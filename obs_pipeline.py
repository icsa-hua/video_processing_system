...
def main():
    ...
    argparser.add_argument('--source', metavar='SO', default='samples/highway_attika.mp4', help='Source to use - Local video path (.mp4) or stream index (key needs to be provided)')
