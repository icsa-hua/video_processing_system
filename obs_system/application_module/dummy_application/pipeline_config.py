...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    argparser.add_argument( "--model_name", metavar="M", default=DEFAULT_MODEL, help="Model to use (Yolov5, Yolov8 (Default), MaskRCNN, ONNX (yolov5, yolov8))",)

    argparser.add_argument( "--video_source", metavar="SO", default=DEFAULT_VIDEO_SOURCE, help="Source to use - Local video path (.mp4) or stream index (key needs to be provided)",)
    ...
    argparser.add_argument( "--roi_profile", metavar="RP", default="", help="Optional ROI profile key from obs_system/utils/roi_profiles.json. If omitted, the video path/name is matched automatically.",)
